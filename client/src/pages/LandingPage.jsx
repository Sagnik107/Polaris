...
export const LandingPage = () => {
  ...
  const [activeConsoleTab, setActiveConsoleTab] = useState('expeditions');
  ...
  return (
    <div className="bg-polar-950 text-text-primary antialiased selection:bg-ice-500 selection:text-polar-950 overflow-x-hidden min-h-screen relative font-body text-body-md">
      {/* Atmospheric Aurora Borealis Background Glows */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute inset-0 opacity-80" style={{
          backgroundImage: 'linear-gradient(to right, rgba(130, 190, 225, 0.03) 1px, transparent 1px), linear-gradient(to bottom, rgba(130, 190, 225, 0.03) 1px, transparent 1px)',
          backgroundSize: '40px 40px'
        }} />
        {/* Deep teal/cyan aurora ambient light pools */}
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Top Navigation Bar */}
        <header className="sticky top-0 w-full h-16 border-b border-border-default bg-surface-1 backdrop-blur-md z-50">
          <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate('/')}>
              <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-surface-2 border border-border-strong shadow-[0_0_16px_rgba(40,169,245,0.35)]">
                <span className="material-symbols-outlined text-ice-400" style={{ fontVariationSettings: "'FILL' 1" }}>
                  explore
                </span>
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <span className="font-headline text-lg font-bold tracking-widest text-text-primary">POLARIS</span>
            ...
            <nav className="hidden md:flex items-center gap-8 text-sm">
              <a className="text-ice-400 border-b-2 border-ice-400 font-medium py-1 transition-colors duration-150" href="#home">Home</a>
              <a className="text-text-muted hover:text-text-primary transition-colors duration-150 py-1" href="#about">About</a>
              <a className="text-text-muted hover:text-text-primary transition-colors duration-150 py-1" href="#features">Features</a>
              <a className="text-text-muted hover:text-text-primary transition-colors duration-150 py-1" href="#operations">Operations</a>
              <a className="text-text-muted hover:text-text-primary transition-colors duration-150 py-1" href="#contact">Contact</a>
            </nav>

            {/* Trailing Actions & Operator Login */}
            <div className="flex items-center gap-4">
              <div className="hidden lg:flex items-center gap-2 px-2.5 py-1 rounded-full bg-surface-2 border border-border-default text-xs font-mono">
                <span className="w-2 h-2 rounded-full bg-success shadow-[0_0_8px_rgba(49,212,154,0.6)]" />
                <span className="text-text-secondary">DEFCON-5 // GRID NORMAL</span>
              </div>

              <button
                onClick={() => navigate('/login')}
                className="relative group flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-2 hover:bg-surface-3 text-ice-300 hover:text-text-primary border border-border-default hover:border-border-strong transition-all duration-200 active:scale-[0.98] cursor-pointer"
              >
                <span className="material-symbols-outlined text-ice-400 text-lg">lock</span>
                <span className="text-xs font-mono tracking-wider font-semibold">Operator Login</span>
              </button>
            </div>
          </div>
        </header>
        ...
        <main className="flex-1 flex flex-col items-center">
          ...
          <section className="w-full max-w-7xl mx-auto px-6 pt-16 pb-12 flex flex-col items-center text-center relative">
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-surface-2 border border-border-strong mb-8 shadow-[0_0_14px_rgba(40,169,245,0.15)] text-xs font-mono">
              <span className="w-1.5 h-1.5 rounded-full bg-aurora-400" />
              <span className="text-aurora-400 tracking-wider">SYS ACTIVE • POLAR MISSION CONTROLLER v4.2</span>
              <span className="text-border-default">|</span>
              <span className="text-text-muted">77°51'S 166°40'E</span>
            </div>

            {/* Main Display Headline in Space Grotesk */}
            <h1 className="font-headline text-4xl sm:text-5xl lg:text-6xl max-w-4xl tracking-tight text-text-primary font-bold mb-6 leading-tight">
            ...
            <p className="font-body text-base sm:text-lg text-text-secondary max-w-2xl mb-10 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mb-16 w-full sm:w-auto">
              <button
                onClick={() => navigate('/login')}
                className="w-full sm:w-auto px-7 py-3.5 rounded-lg bg-gradient-to-r from-ice-500 to-sky-500 hover:from-ice-400 hover:to-sky-400 text-polar-950 font-headline text-sm font-semibold tracking-wide shadow-[0_0_24px_rgba(40,169,245,0.45)] hover:shadow-[0_0_32px_rgba(40,169,245,0.65)] transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2.5 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-7 py-3.5 rounded-lg bg-surface-1 hover:bg-surface-2 text-text-primary border border-border-default hover:border-border-strong backdrop-blur-md font-headline text-sm font-medium transition-all duration-200 active:scale-[0.98] flex items-center justify-center gap-2.5 cursor-pointer"
              >
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-4 border-y border-border-default/60 py-6 bg-surface-1/40 backdrop-blur-sm px-4 rounded-xl">
          ...
          <section className="w-full max-w-7xl mx-auto px-6 pb-24" id="operations">
            <div className="relative rounded-2xl p-1 bg-gradient-to-b from-border-strong via-border-default/40 to-transparent shadow-[0_20px_50px_rgba(2,9,20,0.8)]">
              <div className="rounded-[14px] bg-polar-900 border border-border-default/80 backdrop-blur-xl overflow-hidden">
                  ...
                  <div className="lg:col-span-7 flex flex-col gap-4">
                    <div className="relative h-[380px] rounded-xl border border-border-default bg-surface-2 overflow-hidden flex flex-col justify-between p-4">
                      ...
                      <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-2 px-2.5 py-1 rounded bg-surface-3/90 backdrop-blur-md border border-border-strong text-xs font-mono">
                          <span className="material-symbols-outlined text-ice-400 text-sm">near_me</span>
                          <span className="text-text-primary">TRANS-ANTARCTIC TRAVERSE // ROUTE 04</span>
                        </div>
                        <span className="text-xs font-mono text-ice-300 bg-surface-2/80 px-2 py-0.5 rounded border border-border-default">
                      ...
                      <div className="relative z-10 flex flex-col gap-2 my-auto">
                        ...
                        <div
                          ...
                          className="flex items-center gap-3 p-2.5 rounded-lg bg-surface-1/90 backdrop-blur-md border border-border-strong max-w-sm ml-4 shadow-[0_0_16px_rgba(40,169,245,0.2)] cursor-pointer hover:border-ice-400 transition-all"
                        >
                          <div className="w-2.5 h-2.5 rounded-full bg-ice-400 animate-ping" />
                          <div className="flex-1">
                            <div className="flex justify-between items-center">
                              <span className="font-headline text-sm font-semibold text-text-primary">Expedition Unit Boreas-VII</span>
                              <span className="text-xs font-mono text-aurora-400 font-semibold">NOMINAL</span>
                            </div>
                            <div className="flex items-center gap-3 text-text-muted text-[11px] font-mono mt-0.5">
                        ...
                        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-surface-1/80 backdrop-blur-md border border-border-default max-w-xs ml-12">
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between items-center">
                              <span className="font-headline text-sm font-medium text-text-primary">Autonomous Sled Alpha</span>
                              <span className="text-xs font-mono text-warning font-semibold">CREVASSE FLAGGED</span>
                            </div>
                            <div className="text-text-muted text-[11px] font-mono">AUTOPILOT REROUTING (+4.2 km)</div>
                          </div>
                        </div>
                      </div>

                      {/* Bottom HUD Status Bar */}
                      <div className="relative z-10 flex items-center justify-between text-text-muted text-xs font-mono bg-surface-2/90 backdrop-blur-md p-2 rounded-lg border border-border-default">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      <div className="p-3 rounded-lg bg-surface-2 border border-border-default">
                        <div className="text-xs font-mono text-text-muted mb-1">CONVOY FUEL RESERVE</div>
                        <div className="flex items-baseline justify-between">
                          <span className="font-mono text-lg font-bold text-text-primary">87.4%</span>
                          <span className="text-xs font-mono text-success">+360 NM</span>
                        </div>
                      ...
                      <div className="p-3 rounded-lg bg-surface-2 border border-border-default">
                        <div className="text-xs font-mono text-text-muted mb-1">ATMOSPHERIC PRESSURE</div>
                        <div className="flex items-baseline justify-between">
                          <span className="font-mono text-lg font-bold text-text-primary">982 hPa</span>
                          <span className="text-xs font-mono text-warning">STABLE</span>
                        </div>
                        <div className="w-full h-1 bg-polar-800 rounded-full mt-2 overflow-hidden">
                      ...
                      <div className="p-3 rounded-lg bg-surface-2 border border-border-default">
                        <div className="text-xs font-mono text-text-muted mb-1">CREW BIOMETRIC AVG</div>
                        <div className="flex items-baseline justify-between">
                          <span className="font-mono text-lg font-bold text-text-primary">74 BPM</span>
                          <span className="text-xs font-mono text-aurora-400">OPTIMAL</span>
                        </div>
                        <div className="w-full h-1 bg-polar-800 rounded-full mt-2 overflow-hidden">
                    ...
                    <div className="p-4 rounded-xl bg-surface-2 border border-border-default flex flex-col">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-headline text-xs font-semibold text-text-primary">CRITICAL EXPEDITION PAYLOAD</span>
                        </div>
                        <span className="text-[10px] font-mono text-ice-400 bg-ice-500/10 px-2 py-0.5 rounded border border-ice-500/20">RFID SYNCED</span>
                      </div>
                      ...
                      <div className="flex flex-col gap-2">
                        <div className="flex items-center justify-between p-2.5 rounded bg-surface-1 border border-border-default">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-xs font-mono text-text-primary">Cryo-Plasma Kits & Diagnostics</div>
                              <div className="text-[10px] font-mono text-text-muted">CONTAINER #CX-902 • TEMP: -78°C SEALED</div>
                            </div>
                          </div>
                          <span className="text-xs font-mono text-success">100% INTACT</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-2.5 rounded bg-surface-1 border border-border-default">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <div className="text-xs font-mono text-text-primary">Deep Core Thermal Drills (x2)</div>
                              <div className="text-[10px] font-mono text-text-muted">CONTAINER #DR-014 • TELEMETRY ONLINE</div>
                            </div>
                          </div>
                          <span className="text-xs font-mono text-ice-300">CALIBRATED</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 p-4 rounded-xl bg-surface-2 border border-border-default flex flex-col">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-headline text-xs font-semibold text-text-primary">MISSION TELEMETRY LOG</span>
                        </div>
                        <span className="text-[11px] font-mono text-text-muted">BUFFER: 256 EVT/S</span>
                      </div>

                      <div className="flex-1 text-xs font-mono space-y-2.5 text-text-secondary overflow-hidden">
                        <div className="flex items-start gap-2 border-b border-border-default/40 pb-2">
                          ...
                          <span className="text-text-primary">McMurdo Station relay confirms storm front delta shift to 120km NNE.</span>
                        </div>
                        <div className="flex items-start gap-2 border-b border-border-default/40 pb-2">
                          <span className="text-text-muted">21:43:18</span>
                          <span className="text-ice-400">[ROUTER]</span>
                          <span className="text-text-primary">Traverse Unit Boreas-VII switched uplink to LEO Sat-4; latency: 42ms.</span>
                        </div>
                        <div className="flex items-start gap-2 border-b border-border-default/40 pb-2">
                          <span className="text-text-muted">21:41:50</span>
                          <span className="text-warning">[ICE-ICE]</span>
                          <span className="text-text-primary">Sub-surface acoustic scan indicates 1.2m crevasse bridging required at WP-12.</span>
                        </div>
                        <div className="flex items-start gap-2">
                          <span className="text-text-muted">21:39:11</span>
                          <span className="text-text-primary">[DISPATCH]</span>
                          <span className="text-text-primary">Supply Drone Falcon-3 pre-flight thermal checks passed for Amundsen-Scott leg.</span>
                        </div>
                      </div>

                      {/* Quick Action Button in Console */}
                      <div className="mt-4 pt-3 border-t border-border-default flex items-center justify-between">
                        <span className="text-[11px] font-mono text-text-muted">ARCTIC DISPATCH PROTOCOL: STANDBY</span>
                        <button
                          onClick={() => navigate('/emergency')}
                          className="px-3 py-1.5 rounded bg-surface-3 hover:bg-surface-container text-ice-300 hover:text-text-primary border border-border-default text-xs font-mono flex items-center gap-1.5 transition-colors duration-150 cursor-pointer"
                        >
                ...
                <div className="px-6 py-2.5 bg-polar-950 border-t border-border-default flex flex-wrap items-center justify-between text-xs font-mono text-text-muted">
                  <div className="flex items-center gap-4">
                  ...
                  <div className="text-ice-400">
                    CONNECTED TO POLARIS HIGH LATITUDE MESH NETWORK
                  </div>
                </div>
              </div>
            </div>
          ...
          <footer className="w-full border-t border-border-default bg-surface-1 py-10 mt-auto">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                ...
                <span className="font-headline text-sm font-semibold text-text-primary tracking-wider">POLARIS ARCTIC C2 OPERATIONS</span>
                <span className="text-border-default">|</span>
